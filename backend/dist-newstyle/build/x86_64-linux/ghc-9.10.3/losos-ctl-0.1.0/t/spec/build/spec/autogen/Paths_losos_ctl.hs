...
-- at runtime using the environment variable losos_ctl_bindir.
...
-- environment variable losos_ctl_libdir.
...
-- using the environment variable losos_ctl_dynlibdir.
...
-- runtime using the environment variable losos_ctl_datadir.
...
-- using the environment variable losos_ctl_sysconfdir.
...
bindir     = "/home/matus/.cabal/bin"
libdir     = "/home/matus/.cabal/lib/x86_64-linux-ghc-9.10.3-c01c/losos-ctl-0.1.0-inplace-spec"
dynlibdir  = "/home/matus/.cabal/lib/x86_64-linux-ghc-9.10.3-c01c"
datadir    = "/home/matus/.cabal/share/x86_64-linux-ghc-9.10.3-c01c/losos-ctl-0.1.0"
libexecdir = "/home/matus/.cabal/libexec/x86_64-linux-ghc-9.10.3-c01c/losos-ctl-0.1.0"
sysconfdir = "/home/matus/.cabal/etc"

getBinDir     = catchIO (getEnv "losos_ctl_bindir")     (\_ -> return bindir)
getLibDir     = catchIO (getEnv "losos_ctl_libdir")     (\_ -> return libdir)
getDynLibDir  = catchIO (getEnv "losos_ctl_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "losos_ctl_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "losos_ctl_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "losos_ctl_sysconfdir") (\_ -> return sysconfdir)
